...
const SocialLink = ({url, title}) => (
  <li>
    <a href={url} target="_blank" rel="noreferrer noopener nofollow">{title}</a>
  </li>
);
          ...
          <div>
            <ul style={styles.socialLinks}>
              <SocialLink
                ...
                url={"https://facebook.com/sharer/sharer.php?u=" + protocol + baseURL} />
              <SocialLink
                title={<Icons type={IconType.TWITTER} />}
                url={"https://twitter.com/share?url=" + protocol + baseURL + "&text=" + post.title + "&via=blog.vighnesh153.com"} />
              <SocialLink
                title={<Icons type={IconType.LINKEDIN} />}
                url={"https://www.linkedin.com/sharing/share-offsite/?url=" + encodeURI(baseURL)} />
            </ul>
